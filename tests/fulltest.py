...
os.system("rm fulltest.log fulltest.foo")
...
cmd = "burst {0} 'python3 fulltest_command.py --testpath={1}/{2}' 2>&1 | tee fulltest.log".format(opts, root, args.testpath)
print (cmd)
os.system(cmd)
